...
plt.title("SlidingWindow for SGDClassifier in MNIST + C_MNIST Brightness – change in chunk size")
...
plt.axvline(drift_chunk - 1, linestyle="--", color="black", label="Drift")
plt.title("UnlearningClassifier for SGDClassifier in MNIST + C_MNIST Brightness – change in chunk size")
plt.xlabel("Number of samples")
plt.ylabel("Rolling accuracy")
plt.legend()
plt.tight_layout()
