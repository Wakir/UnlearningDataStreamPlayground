...
from strlearn2.classifiers import FisherUnlearningAdam
...
def run_experiment(chunk_size, dataset_name, semantic_case_1, semantic_case_2, window_size, random_seed, ulr, metrics):
    stream = DataStream(
...
def mlflow_run(chunk_size, dataset_name, semantic_case_1, semantic_case_2, window_size, random_seed, ulrealing_rate, metrics):
...
ulrealing_rates = [0.01, 0.02, 0.03, 0.05, 0.07, 0.10, 0.12, 0.15, 0.17, 0.20, 0.25, 0.30, 0.35, 0.40, 0.45, 0.50]
...
window_sizes = [20]
random_seeds = [42, 65, 88]
ulrealing_rates = [0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.4, 0.5]
...
mlflow.set_experiment("FashionMNIST_Unlearningrate")
...
param_grid = [
    (chunk_size, semantic_case_1, semantic_case_2, window_size, ulrealing_rate, random_seed)
    for chunk_size, semantic_case_1, semantic_case_2, window_size, ulrealing_rate, random_seed
...
results = Parallel(n_jobs=-1, verbose=10)(
    ...
    for chunk_size, semantic_case_1, semantic_case_2, window_size, ulrealing_rate, random_seed in param_grid
)
